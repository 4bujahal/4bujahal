...
<head>
        ...
        <title>Hitung Cepat Real Count Pilkada Kabupaten Ogan Komering Ulu 2024</title>
    ...
    <body>
      <?php include "getData.php"; ?>
        <header id="header">
          <div class="container"><h1 style="text-align: center; color: white;"> HASIL HITUNG CEPAT SUARA SAH Pilkada Kabupaten Ogan Komering Ulu 2024 </h1></div>
        </header>
        <section id="main">
            <section id="content">
                <div class="container">
